...
👀 Cómo verla
Descargá o cloná el repo.
Abrí index.html en el navegador.
Elegí el área que querés ver.
...
➕ Cómo sumar tu área
Copiá la carpeta areas/_plantilla/ y renombrala con tu área (por ejemplo, areas/adquisicion/).
Editá solo el archivo config.js de tu carpeta:
el nombre del área
las salas
los personajes: nombre, puesto, sala, horario y colores de ropa
los datos de ejemplo de la bitácora
Agregá tu área al listado de index.html.
...
Atrasado o sin uso
⚪ Gris
Fuera de turno / vacante
🔴 Rojo
Con fallas


El detalle completo está en ESTILO.md.
